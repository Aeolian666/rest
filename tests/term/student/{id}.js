...
/**
 * Test for /term/student/{id}
 */
Test('/term/student/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 405
         */
        t.test('test getStudentTerms get operation', function (t) {
            Mockgen().requests({
                path: '/term/student/{id}',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/term/student/{id}']['get']['responses']['200']['schema']);
