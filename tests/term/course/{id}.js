...
/**
 * Test for /term/course/{id}
 */
Test('/term/course/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 405
         */
        t.test('test getCourseTerms get operation', function (t) {
            Mockgen().requests({
                path: '/term/course/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/term/course/{id}']['get']['responses']['200']['schema']);
